package com.api.randomsmartphone.exception;
...
import com.api.randomsmartphone.builder.ResponseEntityBuilder;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex) {
		...
		ApiError err = new ApiError(LocalDateTime.now(),HttpStatus.NOT_FOUND, "Resource Not Found" ,errors);
	 ...
	 * HttpMediaTypeNotSupportedException ex, HttpHeaders headers, HttpStatus
	 ...
	 * ResponseEntity<?> handleConstraintViolationException(Exception ex, WebRequest
	 * request) {
	 * 
	 * List<String> details = new ArrayList<String>(); details.add(ex.getMessage());
	 * 
